    ...
    return class List<T> extends PureComponent<Props<T>, State> {
        ...
        scrollToItem(index: number, align: ScrollToAlign = 'auto'): void {
            ...
            if (this._outerRef) {
                ...
                if (layout === 'vertical') {
                    scrollbarSize =
                        outerRef.scrollWidth > outerRef.clientWidth ? getScrollbarSize() : 0;
                } else {
                    scrollbarSize =
                        outerRef.scrollHeight > outerRef.clientHeight ? getScrollbarSize() : 0;
                }
            }
        ...
        render() {
            ...
            return (
                <ScrollView
                    ...
                    style={outerStyle}>
                    <View ref={innerRef} style={innerStyle}>
                        {items}
                    </View>
                </ScrollView>
            );
...
const validateSharedProps = (
    { children, direction, height, layout, width }: Props<any>,
    { instance: _ }: State,
): void => {
