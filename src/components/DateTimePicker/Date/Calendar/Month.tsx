...
function Month(props: MonthSingleProps | MonthRangeProps | MonthMultiProps) {
    ...
    const {
        ...
        const { monthLabel, yearButton, yearButtonInner } = monthStyles;
        ...
        return {
            ...
            monthLabelStyle: [monthLabel, theme.typescale.bodyMedium],
            iconContainerStyle: isHorizontal ? styles.opacity1 : styles.opacity0,
        };
    }, [index, isHorizontal, monthStyles, roundness, scrollMode, theme.typescale.bodyMedium]);
