import type { PropsWithoutRef, RefAttributes, ReactElement } from 'react';
import type {
    ViewStyle,
    ListRenderItemInfo,
 ...
 */
export interface FlatGridProps<ItemType = any> extends FlatListProps<ItemType>, CommonProps {
    /**
