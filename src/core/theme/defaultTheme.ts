...
export const defaultThemeValue: Partial<ITheme> = {
    ...
    DatePickerDocked_MonthItem: datePickerDockedMonthItemStyles,
    ...
    DatePickerDocked_Header: datePickerDockedHeaderStyles,
    DatePicker_HeaderItem: datePickerHeaderItemStyles,
