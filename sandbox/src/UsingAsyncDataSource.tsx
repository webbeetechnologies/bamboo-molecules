  ...
  return new Promise(function (resolve, reject) {
    axios
      ...
      .then(function (result: AxiosResponse<{ customerIds: number[] }>) {
        var dataPromises = result.data.customerIds./*splice(0, Math.floor(Math.random() * 10)).*/map(function (customerId: number) {
          return axios.get('customers/' + customerId, { baseURL: baseURL }) as Promise<AxiosResponse<RecordType>>;
        });
