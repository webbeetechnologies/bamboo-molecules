...
export type Sortable = { isSortable: true, sorting: { disabled?: boolean, isNestedSort?: boolean, sort: Sort[] } } ;
...
export type OnSortAction = SortAction | ApplySortAction | ReorderSortAction | RemoveSortAction | UpdateSortAction
...
type SortableDataSourcePropsWithoutOnSort<T extends {}> = Omit<SortableDataSourcePropsEnabled<T>, keyof DataSourceGetStateReturnOmits>
...
export type SortableDataSourceProps<T extends {}> = SortableDataSourcePropsEnabled<T> | NotSortableReturnProps<T>
