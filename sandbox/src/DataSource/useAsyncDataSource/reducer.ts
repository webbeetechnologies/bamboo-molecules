...
import {
    reduceCompleteLoadResults,
    reduceErrorLoadResults,
    reduceLoadInitialResults,
    reduceStartLoadResults
} from "../reducers/reduceLoadResults";
import { reduceGoTo, reduceGoToEnd, reduceGoToNext, reduceGoToPrev, reduceGoToStart } from "../reducers/reducePagination";
import {reduceRecords, reduceUpdateRecords} from "../reducers/reduceRecords";
...
export const reducer = createReducer({
    ...
    [EStoreActions.UPDATE_RECORDS]: reduceUpdateRecords,
    ...
    [EStoreActions.LOAD_RESULTS_START]: reduceStartLoadResults,
    [EStoreActions.LOAD_RESULTS_DONE]: reduceCompleteLoadResults,
    [EStoreActions.LOAD_RESULTS_ERROR]: reduceErrorLoadResults,
    [EStoreActions.LOAD_INITIAL_RESULTS]: reduceLoadInitialResults,
});