...
const TextInput = forwardRef<TextInputHandles, Props>(
    (
        ...
        const inputHeight =
            finalHeight < (componentStyles as any).inputMinHeight
                ? (componentStyles as any).inputMinHeight
                : finalHeight;
        ...
        const computedStyles = useMemo(
            () => ({
                ...
                supportingText: styles.supportingText,
                ...
                underlineStyle: [
                    ...
                    {
                        backgroundColor:
                            (hasActiveOutline ? activeUnderlineColorProp : underlineColorProp) ||
                            styles.activeIndicator?.backgroundColor,
                    },
                ],
                outlineStyle: [
                    styles.outline,
                    ...
                    {
                        borderColor:
                            (hasActiveOutline ? activeOutlineColorProp : outlineColorProp) ||
        ...
        return (
            <>
                <View style={[computedStyles.container, style]}>
                    ...
                    {left && (
                        <View
                            style={computedStyles.leftElement}
                    ...
                    <View
                        ...
                        {variant !== 'plain' && (
                            <InputLabel
                                ...
                                testID={rest.testID}
                                style={computedStyles.labelText}
                            />
                        )}
                    ...
                    {right && (
                        <View
                            style={computedStyles.rightElement}
